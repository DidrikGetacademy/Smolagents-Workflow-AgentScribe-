...
def get_automatic_data_from_agent(model,input_video):
        ...
        def save_thought_and_code(step_output):
                    ...
                    if "Thought:" in text and "Code:" in text:
                        ...
                        code = text.strip()
                    test_log_list.append(f"Thought:\n{thought}\n\nCode:\n{code}\n\n")
        ...
        try:
            ...
            save_full_io_to_file(modelname="TestAgent",input_chunk=user_task,reasoning_steps=test_log_list,model_response=Response,file_path=r"C:\Users\didri\Desktop\Full-Agent-Flow_VideoEditing\top10_test.txt")
        except Exception as e:
