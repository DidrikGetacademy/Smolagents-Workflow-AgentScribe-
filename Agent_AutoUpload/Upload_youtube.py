...
from Custom_Agent_Tools import ExtractAudioFromVideo, Fetch_top_trending_youtube_videos,Read_transcript
import gc
import torch
load_dotenv()
import yaml
...
if __name__ == "__main__":
    ...
    upload_video(model=model,file_path=r"Video_clips/short12_rife.mp4")
